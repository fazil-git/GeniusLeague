			...
			<div class="card-body">
				<form action="taketest">
					<h2>
					 ...
					 <p>Your last score is : ${user.score }</p>
					 <c:if test="${user.score ge 5 }">
					 	<label class="font" style="color:blue">Congrats!<br>You have passed the quiz.</label><br>
					 	<label class="font-italic">You are doing great!</label><br>
					 </c:if>
					 <c:if test="${user.score lt 5 }">
						<label class="font" style="color:tomato">Sorry, You didn't pass! <br>Passing score is 5.</label><br>
